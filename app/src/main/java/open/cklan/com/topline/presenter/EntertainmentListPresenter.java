 ...
 */
public class EntertainmentListPresenter extends BaseListPresenter{
    EntertainmentService service;

    @Inject
    public EntertainmentListPresenter(NewsListContract.View view, EntertainmentService service) {
        this.view=view;
    ...
    public void refreshNewsList(String tid,long offset,long size) {
        service.newsList(tid,offset,size)
                ...
                .observeOn(AndroidSchedulers.mainThread()).subscribe(new Subscriber<Response<NewsListEntity<EntertainmentListItemEntity>>>() {
            @Override
            ...
            @Override
            public void onNext(Response<NewsListEntity<EntertainmentListItemEntity>> newsListEntityResponse) {
