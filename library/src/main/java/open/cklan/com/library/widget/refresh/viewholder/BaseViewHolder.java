package open.cklan.com.library.widget.refresh.viewholder;
...
/**
 * AUTHOR：lanchuanke on 17/5/10 18:25
 */
public class BaseViewHolder extends RecyclerView.ViewHolder {
    ...
    public BaseViewHolder setImageUrl(@IdRes int viewId, String url){
        ...
        Glide.with(view.getContext())
                ...
                .crossFade()
                .placeholder(R.drawable.image_list_place_holder)
                .into(view);
        return this;
    }

    public BaseViewHolder setSize(@IdRes int viewId,int width,int height){
        View view=getView(viewId);
    ...
    public BaseViewHolder addOnClickListener(@IdRes final int viewId, final BaseAdapter.OnItemClickListener listener) {
        ...
        if (view != null) {
            ...
            view.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (listener != null) {
                        listener.onItemClick(adapter,view,getClickPosition());
                    }
                }
            });
        }
